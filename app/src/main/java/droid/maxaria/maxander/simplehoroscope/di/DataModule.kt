...
import droid.maxaria.maxander.data.HoroscopeRepositoryImpl
...
class DataModule {
    @Provides
    fun provideRepository(apiProvider: ApiProvider,dao: PredictDao):HoroscopeRepository {
        return HoroscopeRepositoryImpl(apiProvider = apiProvider, predictDao = dao)
    }
    @Provides
